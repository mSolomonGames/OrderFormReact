            ...
            <Grid container justify="center">
                ...
                {state.paymentType === "debit" ? (
                    ...
                    <Select
                        ...
                        color="primary"
                    >
                        <MenuItem value={moment().add('months', 1).date(1).format('DD-MM-YYYY')}><Typography color="textPrimary" variant="subtitle1" align="center">1st of Every Month</Typography></MenuItem>
                        <MenuItem value={moment().add('months', 1).date(15).format('DD-MM-YYYY')}><Typography color="textPrimary" variant="subtitle1" align="center">15th of Every Month</Typography></MenuItem>
                        <MenuItem value={moment().add('months', 2).date(1).subtract('days', 1).format('DD-MM-YYYY')}><Typography color="textPrimary" variant="subtitle1" align="center">Last Day of Every Month</Typography></MenuItem>
                    </Select>
                </Grid>) : <></>}
