...
export default () => {
    ...
    const [fibreDetails, setFibrePackage]= useState({
    ...
    function setWifiPackage36(i){
        setSelectedIndex(i);
        fibreDetails.speed = packages24[i-offsetMonths].speed;
        fibreDetails.price = packages24[i-offsetMonths].price36;
        fibreDetails.install_price = installation.price;
    }

    function setWifiPackage24(i){
        setSelectedIndex(i);
        fibreDetails.speed = packages24[i].speed;
        fibreDetails.price = packages24[i].price24;
        fibreDetails.install_price = installation.price;
    }
    ...
    return (        
        <Grid container className={classes.root} justify="center" alignItems="center">
            ...
            <Typography className={classes.tableHeading} color="textSecondary" variant="h5" align="left" >Fibre Packages</Typography>
            </Grid>
            <Grid item md={6} >
            ...
            <Grid item md={12} xs={12}>           
                <Typography className={classes.gridHeading , classes.subtitleBackground} color="textSecondary" variant="h6" align="center" >Enterprise Installation: R{installation.price} excl. VAT</Typography>
            </Grid>
        </Grid>
    )
}